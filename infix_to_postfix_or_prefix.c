/* This program is basically designed to convert an inputted infix expression to a postfix or prefix expresssion,
   and evaluation of that expression as per users need*/
		...
		switch(choice)
		{
			case 1:
				...
				if(ch == 'y' || ch == 'Y')
				{
					...
					printf("\t\tResult for your postfix expression is = %d",(int)stack[top] - 48);
				}
				break;
			case 2:
				printf("\n\t\tEnter an infix expression = ");
				...
				if(ch == 'y' || ch == 'Y')
				{
					...
					printf("\t\tResult for your prefix expression is = %d",(int)stack[top] - 48);
				}
				break;
			case 3:
				exit(0);
